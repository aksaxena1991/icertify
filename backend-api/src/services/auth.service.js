...
const loginUserWithEmailAndPassword = async (email, password) => {
  ...
  const user = await userService.getUserById(userByEmail.id)
...
const verifyAuth = async (authToken) => {
  try {
const authTokenDoc = await tokenService.verifyToken(authToken, tokenTypes.ACCESS);
...
const verifyAccessToken = async (verifyAccessToken) => {
  try {
