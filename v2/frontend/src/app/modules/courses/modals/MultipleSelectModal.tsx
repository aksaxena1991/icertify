...
const MultipleSelectModal = (props: any) => {
...
createQuestion({
            question,explaination,exhibit,caseStudyId,practiceTestId,courseId,rightOption:Object.values(rightOption).join('$icertify'),questionType:'SELECT',options:opt.join('$icertify$')
        });
    }
            ...
            <div className="modal-content multiple-choice-modal-content">
                ...
                <div className="modal-body">
                    ...
                    <div className="row mb-10">
                        ...
                        <div className="col-md-12">
                            <div className="input-group input-group-solid">
                                <span className="input-group-text">A<input type="checkbox" name="radioRightOption" id="option_ans_1" className="ms-2 form-check-input"  onChange={(evt:any)=>rightOptionHandler(evt)}></input></span>
                    ...
                    <div className="row mb-10">
                        ...
                        <div className="col-md-12">
                            <div className="input-group input-group-solid">
                                <span className="input-group-text">B<input type="checkbox" name="radioRightOption" id="option_ans_2" className="ms-2 form-check-input"  onChange={(evt:any)=>rightOptionHandler(evt)}></input></span>
                                <textarea className="form-control" aria-label="With textarea" onChange={(evt:any)=>
                        setRadioValue(evt)
                    ...
                    <div className="row mb-10">
                        ...
                        <div className="col-md-12">
                            <div className="input-group input-group-solid">
                                <span className="input-group-text">C<input type="checkbox" name="radioRightOption" id="option_ans_3" className="ms-2 form-check-input"  onChange={(evt:any)=>rightOptionHandler(evt)}></input></span>
                                <textarea className="form-control" aria-label="With textarea" onChange={(evt:any)=>
                        setRadioValue(evt)
                    ...
                    <div className="row mb-10">
                        ...
                        <div className="col-md-12">
                            <div className="input-group input-group-solid">
                                <span className="input-group-text">D<input type="checkbox" name="radioRightOption" id="option_ans_4" className="ms-2 form-check-input"  onChange={(evt:any)=>rightOptionHandler(evt)}></input></span>
                                <textarea className="form-control" aria-label="With textarea" onChange={(evt:any)=>
                        setRadioValue(evt)
                    ...
                    <div className="row mb-10">
                        ...
                        <div className="col-md-12">
                            <div className="input-group input-group-solid">
                                <span className="input-group-text">E<input type="checkbox" name="radioRightOption" id="option_ans_5" className="ms-2 form-check-input"  onChange={(evt:any)=>rightOptionHandler(evt)}></input></span>
                                <textarea className="form-control" aria-label="With textarea" onChange={(evt:any)=>
                        setRadioValue(evt)
